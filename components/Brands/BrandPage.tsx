      ...
      <div className="bg-white flex flex-col items-center justify-center px-4 md:px-8 mt-2 mb-12 pop-up">
        ...
        >
          ...
          <div className="relative w-full mb-6">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7E7669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6" /></svg>
            </button>
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7E7669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6" /></svg>
            </button>
